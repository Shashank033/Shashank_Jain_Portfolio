...
In simple terms, if you consider GitHub hosting the GitHub Pages site for this repo at the URL, the correct base directory to set is `/react-portfolio-template/`.
